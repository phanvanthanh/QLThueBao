...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		 <!--  <param name="source" value="ClientBin/SilverlightQLThuebao.xap"/>-->
           <%
               const string sourceValue = @"ClientBin/SilverlightQLThuebao.xap";
             string param;
             ...
             if(System.Diagnostics.Debugger.IsAttached)
             ...
             else
                {
                     ...
                     param = "<param name=\"source\" value=\"" + sourceValue + "?ignore=" + xapCreationDate + "\" />";
                }
